...
const location=false
  return (
    ...
    <Link to={'/'}><h1 className='font-bold text-3xl '><span className='text-blue-500 font-serif'>All In</span> OneKart</h1></Link>
    ...
    <nav className='flex gap-7 items-center'>
      <ul className='flex gap-7 items-center text-xl font-semibold'>
       ...
       <NavLink to={'/product'} className={({isActive})=>`${isActive ? "border-b-3 transition-all border-red-500":"text-black"} cursor-pointer`}><li>Products</li></NavLink> 
